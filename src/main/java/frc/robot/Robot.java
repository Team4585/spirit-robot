...
public class Robot extends HuskyRobot {
  ...
  private SpiritRobotTeleopDecisionMaker m_TeleopDecider = new SpiritRobotTeleopDecisionMaker();
  private SpiritRobotAutonomousDecisionMaker m_AutoDecider = new SpiritRobotAutonomousDecisionMaker();
